      ...
      <div className="app">
        ...
        >
          <Grid item className="" xs={12}>
            ...
            />
            <p>
              Então se puder doe Bitcoins para ajudar a manter o site online:
            </p>
            <div className="align-center">
              ...
              />
              <p className="text-center">18kXMmrDtgfeQgVmwfmygTaYLyQuVS4chK</p>
              <ClipboardButton text="18kXMmrDtgfeQgVmwfmygTaYLyQuVS4chK" />
            </div>
          </Grid>
        </Grid>
      </div>
